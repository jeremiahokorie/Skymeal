...
public class DisplayRice extends AppCompatActivity {
    TextView name;
    ImageView imagess;
    TextView pricess;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_rice);

//Spinner displays the number of quest in a row down form
        myspinner = (Spinner) findViewById(R.id.quantity);
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(DisplayRice.this,
    ...
    public void buttonRice(View view){
