...
public class DisplayRentCar extends AppCompatActivity {
    TextView name;
    ImageView imagess;
    TextView pricess;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_rent_car);
        myspinner = (Spinner)findViewById(R.id.quantity);

        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(DisplayRentCar.this,
                android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.Car_Model));
    ...
    public void exitButton(View view){
        finish();
    }public void buttonCar(View view){
